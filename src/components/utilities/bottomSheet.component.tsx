...
export const BottomSheetComponent = memo(
  forwardRef<BottomSheetRefProps, BottomSheetProps>(
    (
      {
        children,
      ...
      const dragGesture = useMemo(
        () =>
          Gesture.Pan()
            ...
            .onEnd(() => {
              const isCloseThreshold =
                Math.abs(translateY.value) < height * (4 / 5);
              if (isCloseThreshold) {
                runOnJS(close)();
      ...
      const rStyle = useAnimatedStyle(() => {
        const borderRadius = interpolate(
          ...
          [valueStyles.borderRadius, valueStyles.borderRadius10],
          Extrapolation.CLAMP,
        );
      ...
      const BottomSheetWithGestureHandler = gestureHandlerRootHOC(() => (
        <>
          ...
          <GestureDetector gesture={dragGesture}>
            <Animated.View
              style={[styles.container, {backgroundColor}, rStyle]}>
              <View
                style={{
